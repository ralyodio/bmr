...
function program1(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "\n        <audio id=\"inbox-alert\" src=\"/media/";
  if (stack1 = helpers.inbox_notification) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.inbox_notification; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + ".ogg\"></audio>\n    ";
  return buffer;
  }
  ...
  stack1 = helpers['if'].call(depth0, depth0.inbox_notification, {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n</section>";
  return buffer;
  });
...
function program27(depth0,data) {
  ...
  stack1 = helpers['if'].call(depth0, depth0.inbox_notification_thunder, {hash:{},inverse:self.program(3, program3, data),fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  ...
  stack1 = helpers['if'].call(depth0, depth0.inbox_notification_flyby, {hash:{},inverse:self.program(7, program7, data),fn:self.program(5, program5, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  ...
  stack1 = helpers['if'].call(depth0, depth0.inbox_notification_none, {hash:{},inverse:self.program(11, program11, data),fn:self.program(9, program9, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n\n                    None - Don't play any sound when a new message arrives\n                </label>\n            </p>\n        </fieldset>\n\n        <fieldset class=\"has-legend\">\n            <legend>Link proxy</legend>\n            <p>\n                <label>\n                    ";
  stack1 = helpers['if'].call(depth0, depth0.proxy_urls_ixquick, {hash:{},inverse:self.program(15, program15, data),fn:self.program(13, program13, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  ...
  stack1 = helpers['if'].call(depth0, depth0.proxy_urls_anonymouse, {hash:{},inverse:self.program(19, program19, data),fn:self.program(17, program17, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  ...
  stack1 = helpers['if'].call(depth0, depth0.proxy_urls_webproxynet, {hash:{},inverse:self.program(23, program23, data),fn:self.program(21, program21, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n\n                    Show a <a href=\"http://webproxy.net/\" class=\"ext\">webproxy.net</a> proxy link next to URLs in messages\n                </label>\n            </p>\n            <p>\n                <label>\n                    ";
  stack1 = helpers['if'].call(depth0, depth0.proxy_urls_none, {hash:{},inverse:self.program(27, program27, data),fn:self.program(25, program25, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
